...
os.startfile(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "Executables", "Portables", "Stratoshark", "Stratoshark.exe")))

print(f"{BEFORE_CYAN + current_time_hour() + AFTER_CYAN} {NOTE} Stratoshark has now been launched...")
Continue()
Reset()
