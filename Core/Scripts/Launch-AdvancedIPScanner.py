...
os.startfile(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "Executables", "Portables", "AdvancedIPScanner", "advanced_ip_scanner.exe")))

print(f"{BEFORE_CYAN + current_time_hour() + AFTER_CYAN} {NOTE} AdvancedIPScanner has now been launched...")
Continue()
Reset()
