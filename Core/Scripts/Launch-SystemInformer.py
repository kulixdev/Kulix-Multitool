...
os.startfile(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "Executables", "Portables", "SystemInformer", "amd64", "SystemInformer.exe")))

print(f"{BEFORE_CYAN + current_time_hour() + AFTER_CYAN} {NOTE} SystemInformer has now been launched...")
Continue()
Reset()
